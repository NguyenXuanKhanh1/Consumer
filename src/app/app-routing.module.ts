...
import { ListConsumersComponent } from './demo/list-consumers/list-consumers.component';
import { EditConsumerComponent } from './demo/edit-consumer/edit-consumer.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'consumer',
        component: ListConsumersComponent
      },
      {
        path: 'edit-consumer',
